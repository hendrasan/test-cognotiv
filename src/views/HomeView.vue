      ...
      <div class="max-w-[800px] mx-auto">
        <div class="flex flex-col justify-center relative group">
          <h1
            :class="
              cn(
                'text-primary font-bold text-5xl lg:text-8xl z-[2] leading-none mb-4 lg:mb-0 lg:absolute lg:top-0 lg:-left-16 lg:-translate-y-1/2 group-hover:scale-105 transition-transform origin-top-left transition-timing-snappy',
          ...
          <div class="overflow-hidden">
            <img
              ...
              :class="
                cn(
                  'max-h-[440px] grayscale transition-timing-snappy group-hover:grayscale-0 group-hover:scale-125',
                  isLeaving ? 'opacity-0' : ''
                )
              "
          ...
          <div
            :class="
              cn(
                'mt-4 lg:mt-0 lg:absolute lg:-bottom-10 lg:-left-16 translate-y-1/2 transition-timing-snappy',
          ...
          >
            ...
            >
              ...
              >
              <IconLongArrowRight
                class="text-white lg:text-primary grow-0 max-w-[50px] group-hover/btn:text-white transition-all transition-timing-snappy lg:translate-x-full lg:invisible lg:opacity-0 lg:group-hover:translate-x-0 lg:group-hover:visible lg:group-hover:opacity-100"
              />
            </RouterLink>
          </div>
        </div>
